...
public class C7_ProjectApiUnitTests
{
    ...
    {
        await wsApi.UploadStreamAsync(createdProjectId, "test01.mp3", testMp3, testMp3.Length, false, "default", default);
    ...
    {
        createdProjectAccessToken = (await projectApi.TranscribeProjectAsync(createdProjectId, "cs-CZ", true, true, true, true, false, true, "default", default)).AccessToken;
    }
    ...
    {
        var export = await projectApi.ExportWithFormatAsync(createdProjectId, "srt", default);
        Assert.True(export.Content.ReadByte() > -1);
    }
